...
df2015_new$hv201 <- ifelse(df2015_new$hv201 <= 71, 1, 0)

df2015_new$hv205[df2015_new$hv205 > 96] <- NA
df2015_new$hv205 <- ifelse(df2015_new$hv205 < 40 | df2015_new$hv205 == 71, 1, 0) 
