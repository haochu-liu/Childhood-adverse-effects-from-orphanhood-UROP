...
chdf2005["hv121"] <- ifelse(chdf2005$hv121 == 1 | chdf2005$hv121 == 2, 
                                   1, 0)
chdf2005["hv025"] <- ifelse(chdf2005$hv025 == 1, 
                                   1, 0)
chdf2005["hv270"] <- ifelse(chdf2005$hv270<3,1,0)
chdf2005["hv201"] <- ifelse(chdf2005$hv201<22,1,0)
chdf2005["hv205"] <- ifelse(chdf2005$hv205<24,1,0)
...
chdf2005$hv270 <- labelled(chdf2005$hv270, label = "poor household wealth")
...
chdf2005$hv201 <- labelled(chdf2005$hv201, label = "has piped or tube water")
chdf2005$hv205 <- labelled(chdf2005$hv205, label = "has toilet facility")
chdf2005$hv105 <- labelled(chdf2005$hv105, label = "age")
chdf2005$hv104 <- labelled(chdf2005$hv104, label = "gender")
chdf2005$hv025 <- labelled(chdf2005$hv025, label = "lives in urban area")
chdf2005$hv221 <- labelled(chdf2005$hv221, label = "has telephone(land-line)")
#chdf2005$hv243b <- labelled(chdf2005$hv243b, label = "has watch")
...
#chdf2005$hv227 <- labelled(chdf2005$hv227, label = "has mosquito bed net for sleeping")
