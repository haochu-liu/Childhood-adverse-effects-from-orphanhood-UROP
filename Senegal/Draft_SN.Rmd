...
```{r}
chdfchild <- rbind(chdfchild_lfix(chdf2010, "Senegal", "2010", 1,1,1,1),
                  chdfchild_lfix(chdf2012, "Senegal", "2012", 1,2,1,1),
                  chdfchild_lfix(chdf2014, "Senegal", "2014", 2,2,1,1),
                  chdfchild_lfix(chdf2015, "Senegal", "2015", 1,1,1,1),
                  chdfchild_lfix(chdf2016, "Senegal", "2016", 2,2,1,1),
                  chdfchild_lfix(chdf2017, "Senegal", "2017", 2,2,1,1),
                  chdfchild_lfix(chdf2018, "Senegal", "2018", 2,1,1,0),
                  chdfchild_lfix(chdf2019, "Senegal", "2019", 2,1,1,0))

fieller_fix_SN <- rbind(chdfchild)
...
chdfhousehold$"2018" <- c(nrow(chdf2018 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2018) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2017" <- c(nrow(chdf2017 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2017) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2016" <- c(nrow(chdf2016 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2016) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2015" <- c(nrow(chdf2015 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2015) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2014" <- c(nrow(chdf2014 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2014) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2012" <- c(nrow(chdf2012 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2012) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2010" <- c(nrow(chdf2010 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2010) %>% distinct(hv001, hv002, .keep_all = TRUE)))
...
chdfhousehold$"2005" <- c(nrow(chdf2005 %>% distinct(hv001, hv002, .keep_all = TRUE)),
                         nrow(na.omit(chdf2005) %>% distinct(hv001, hv002, .keep_all = TRUE)))
```
