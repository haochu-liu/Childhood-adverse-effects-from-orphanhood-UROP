...
```
```{r}
box2005<-df_boxplot(chdf2005,"BMI","Orphanhood","hv105")
#box2005$hv105<-as.numeric(box2005$hv105)
BMI05<-ggplot(data=box2005,mapping=aes(x=hv105,y=BMI,fill=Orphanhood))+geom_boxplot()+ylim(c(5,35))+geom_boxplot(outlier.colour = "red", outlier.shape = 1)+
  coord_flip()+
  ggtitle("Senegal 2010(Children under 5)")+theme_bw()
print(BMI05)
```
