---
title: "Senegal_Orphanhood_Analysis_2005"
author: "Yujia Luan"
date: "2023-07-16"
output: pdf_document
---
...
```{r}
# draw the barplot
df05fea1<-subset(df05features,df05features$question<3)
ggplot(data = df05fea1, mapping = aes(x=question,y = proportion, fill = orphanhood)) + geom_bar(stat = 'identity', position = 'dodge') + geom_errorbar( aes(ymin=lower, ymax=upper), width=0.4, colour="orange", alpha=0.6,position = position_dodge(.9))
```
