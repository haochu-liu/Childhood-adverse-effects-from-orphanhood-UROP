...
hl_year_df<-rbind(edu_bar_df(chdf2016,2016,"Senegal")[[2]],edu_bar_df(chdf2017,2017,"Senegala")[[2]],edu_bar_df(chdf2018,2018,"Senegal")[[2]],edu_bar_df(chdf2019,2019,"Senegal")[[2]])
